...
if __name__ == "__main__":
	...
	print('CRESCENTE: {}\n'.format(crescent))
	print('EFICIENTE: {}\n'.format(efficiency))
	print('EXATO: {}\n'.format([('input15.in', 20676, '5.5823'), ('input7.in', 1940, '0.84025'), ('input1.in', 31621, '0.40869'), ('input3.in', 143449, '2.81'), ('input11.in', 30001, '8.4843'), ('input12.in', 49885, '2343.9'), ('input9.in', 10281, '13.927'), ('input8.in', 741, '0.56339'), ('input14.in', 20880, '519.17'), ('input6.in', 99861, '33.931'), ('input5.in', 15785, '2.7625'), ('input2.in', 67829, '1.1453'), ('input16.in', 46281, '5.5514'), ('input10.in', 20149, '5.6126'), ('input13.in', 49398, '1041.3'), ('input4.in', 28840, '2.7862')]))