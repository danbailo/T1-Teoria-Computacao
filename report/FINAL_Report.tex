...
% Logo, a seguinte questão é levantada: ''Dentre as Heurísticas Gulosas programadas, qual teria melhor 
% eficiência quando comparado ao resultado do Algoritmo Exato?''
...
%                 \PY{n}{result\PYZus{}final}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{items}\PY{p}{[}\PY{n}{index}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
%                 \PY{n}{value} \PY{o}{+}\PY{o}{=} \PY{n}{value\PYZus{}item}
%                 \PY{n}{weight} \PY{o}{+}\PY{o}{=} \PY{n}{weight\PYZus{}item}
%             \PY{k}{del} \PY{n}{items}\PY{p}{[}\PY{n}{index}\PY{p}{]}
...
%         \PY{k}{for} \PY{n}{item} \PY{o+ow}{in} \PY{n}{values\PYZus{}items}\PY{p}{:}
%             \PY{k}{if} \PY{n}{item} \PY{o+ow}{in} \PY{n}{result\PYZus{}final}\PY{p}{:} \PY{n}{solution}\PY{p}{[}\PY{n}{values\PYZus{}items}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n}{item}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}
%         \PY{k}{return} \PY{n}{solution}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight}
%     \end{Verbatim}
% \end{tcolorbox}    
...
% \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
%     \begin{Verbatim}[commandchars=\\\{\}]
% \PY{k}{def} \PY{n+nf}{local\PYZus{}search}\PY{p}{(}\PY{n}{solution}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{)}\PY{p}{:}
% 	\PY{n}{length} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{solution}\PY{p}{)}
% 	\PY{n}{neighbor} \PY{o}{=} \PY{p}{(}\PY{n}{solution}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight}\PY{p}{)}
...
% 		\PY{k}{if} \PY{n}{solution}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:} 
% 			\PY{k}{if} \PY{n}{weight}\PY{o}{+}\PY{n}{weight\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{weight\PYZus{}max}\PY{p}{:}
% 				\PY{k}{if} \PY{n}{value}\PY{o}{+}\PY{n}{values\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{\PYZgt{}} \PY{n}{neighbor}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{:}
% 					\PY{n}{temp} \PY{o}{=} \PY{n}{solution}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
% 					\PY{n}{temp}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}
% 					\PY{n}{neighbor} \PY{o}{=} \PY{n}{temp}\PY{p}{,} \PY{n}{weight}\PY{o}{+}\PY{n}{weight\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{value}\PY{o}{+}\PY{n}{values\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]}
% 	\PY{k}{if} \PY{n}{value} \PY{o}{==} \PY{n}{neighbor}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{p}{:}\PY{k}{return} \PY{n}{value}
% 	\PY{k}{return} \PY{n}{local\PYZus{}search}\PY{p}{(}\PY{n}{neighbor}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{,} \PY{n}{neighbor}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{neighbor}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{)}
% \end{Verbatim}
% \end{tcolorbox} 
...
% 		\PY{n}{solution}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight} \PY{o}{=} \PY{n}{semi\PYZus{}greedy\PYZus{}construction}\PY{p}{(}\PY{n}{window}\PY{p}{,} \PY{n}{number\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}
% 		\PY{n}{solution} \PY{o}{=} \PY{n}{local\PYZus{}search}\PY{p}{(}\PY{n}{solution}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{)}
% 		\PY{k}{if} \PY{n}{solution} \PY{o}{\PYZgt{}} \PY{n}{best\PYZus{}solution}\PY{p}{:} \PY{n}{best\PYZus{}solution} \PY{o}{=} \PY{n}{solution}
