        ...
        \PY{k}{def} \PY{n+nf}{exact}\PY{p}{(}\PY{n}{number\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{number\PYZus{}items}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:} 
                \PY{k}{for} \PY{n}{weight} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{weight\PYZus{}max}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:} 
                    \PY{k}{if} \PY{n}{i}\PY{o}{==}\PY{l+m+mi}{0} \PY{o+ow}{or} \PY{n}{weight}\PY{o}{==}\PY{l+m+mi}{0}\PY{p}{:} \PY{n}{K}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{weight}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{0} 
                    \PY{k}{elif} \PY{n}{weight\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{weight}\PY{p}{:} \PY{n}{K}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{weight}\PY{p}{]} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{values\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{+} \PY{n}{K}\PY{p}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{weight}\PY{o}{\PYZhy{}}\PY{n}{weight\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{n}{K}\PY{p}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{weight}\PY{p}{]}\PY{p}{)}
                    \PY{k}{else}\PY{p}{:} \PY{n}{K}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{weight}\PY{p}{]} \PY{o}{=} \PY{n}{K}\PY{p}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{n}{weight}\PY{p}{]}    
            \PY{k}{return} \PY{n+nb}{int}\PY{p}{(}\PY{n}{K}\PY{p}{[}\PY{n}{number\PYZus{}items}\PY{p}{]}\PY{p}{[}\PY{n}{weight\PYZus{}max}\PY{p}{]}\PY{p}{)}	
        \end{Verbatim}
        \end{tcolorbox}
...
\begin{figure}
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
        ...
        \PY{k}{def} \PY{n+nf}{crescent}\PY{p}{(}\PY{n}{number\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{number\PYZus{}items}\PY{p}{)}\PY{p}{:} \PY{n}{items}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{values\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,}\PY{n}{weight\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]}	
            \PY{n}{items} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{items}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}
            \PY{n}{result\PYZus{}final} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{n}{weight} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{k}{for} \PY{n}{values\PYZus{}items}\PY{p}{,}\PY{n}{weight\PYZus{}items} \PY{o+ow}{in} \PY{n}{items}\PY{p}{:}
                \PY{k}{if} \PY{n}{weight\PYZus{}items}\PY{o}{+}\PY{n}{weight} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{weight\PYZus{}max}\PY{p}{:}
                    \PY{n}{result\PYZus{}final} \PY{o}{+}\PY{o}{=} \PY{n}{values\PYZus{}items}
                    \PY{n}{weight} \PY{o}{+}\PY{o}{=} \PY{n}{weight\PYZus{}items}
            \PY{k}{return} \PY{n}{result\PYZus{}final}
        \end{Verbatim}
        \end{tcolorbox}
...
\begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
    ...
    \PY{k}{def} \PY{n+nf}{efficiency}\PY{p}{(}\PY{n}{number\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}\PY{p}{:}
        \PY{n}{efficiency} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{divide}\PY{p}{(}\PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}
        \PY{n}{items} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{number\PYZus{}items}\PY{p}{)}\PY{p}{:} \PY{n}{items}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{efficiency}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{[}\PY{n}{i}\PY{p}{]}
        \PY{n}{items} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{items}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{reverse}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        \PY{n}{result\PYZus{}final} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{weight} \PY{o}{=} \PY{l+m+mi}{0}
...
\begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
    ...
    \PY{k}{def} \PY{n+nf}{semi\PYZus{}greedy\PYZus{}construction}\PY{p}{(}\PY{n}{window}\PY{p}{,} \PY{n}{number\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}\PY{p}{:}
        \PY{n}{efficiency} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{divide}\PY{p}{(}\PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}
        \PY{n}{items} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        ...
        \PY{n}{weight} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{aux} \PY{o}{=} \PY{n}{items}\PY{p}{[}\PY{p}{:}\PY{p}{]}
        \PY{k}{while} \PY{n+nb}{len}\PY{p}{(}\PY{n}{items}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0} \PY{o+ow}{and} \PY{n}{weight} \PY{o}{\PYZlt{}} \PY{n}{weight\PYZus{}max}\PY{p}{:}
            \PY{k}{if} \PY{n+nb}{len}\PY{p}{(}\PY{n}{items}\PY{p}{)} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{window}\PY{p}{:} \PY{n}{tmp\PYZus{}window} \PY{o}{=} \PY{n}{window} 
            \PY{k}{else}\PY{p}{:} \PY{n}{tmp\PYZus{}window} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{items}\PY{p}{)}
            \PY{n}{index} \PY{o}{=} \PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{tmp\PYZus{}window}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
            \PY{n}{value\PYZus{}item} \PY{o}{=} \PY{n}{items}\PY{p}{[}\PY{n}{index}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{weight\PYZus{}item} \PY{o}{=} \PY{n}{items}\PY{p}{[}\PY{n}{index}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
            \PY{k}{if} \PY{n}{weight\PYZus{}item}\PY{o}{+}\PY{n}{weight} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{weight\PYZus{}max}\PY{p}{:} 
                \PY{n}{result\PYZus{}final}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{items}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{n}{index}\PY{p}{)}\PY{p}{)}
                \PY{n}{value} \PY{o}{+}\PY{o}{=} \PY{n}{value\PYZus{}item}
                \PY{n}{weight} \PY{o}{+}\PY{o}{=} \PY{n}{weight\PYZus{}item}
            \PY{k}{else}\PY{p}{:} \PY{n}{items}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{n}{index}\PY{p}{)}
        \PY{n}{solution} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{number\PYZus{}items}\PY{p}{,}\PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int16}\PY{p}{)}
        \PY{k}{for} \PY{n}{aux\PYZus{}value} \PY{o+ow}{in} \PY{n}{aux}\PY{p}{:}
            \PY{k}{if} \PY{n}{aux\PYZus{}value} \PY{o+ow}{in} \PY{n}{result\PYZus{}final}\PY{p}{:} \PY{n}{solution}\PY{p}{[}\PY{n}{aux}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n}{aux\PYZus{}value}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}
        \PY{k}{return} \PY{n}{solution}\PY{p}{,} \PY{n}{aux}\PY{p}{,} \PY{n}{value}
    \end{Verbatim}
    \end{tcolorbox}
...
\begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
    \PY{k}{def} \PY{n+nf}{local\PYZus{}search}\PY{p}{(}\PY{n}{solution}\PY{p}{,} \PY{n}{aux}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{)}\PY{p}{:}
        \PY{n}{all\PYZus{}solutions} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{solution\PYZus{}aux} \PY{o}{=} \PY{n}{solution}\PY{p}{[}\PY{p}{:}\PY{p}{]}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{solution}\PY{p}{)}\PY{p}{)}\PY{p}{:}
            \PY{k}{if} \PY{n}{solution}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{:} \PY{n}{solution}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{k}{elif} \PY{n}{solution}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:} \PY{n}{solution}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}
            \PY{n}{all\PYZus{}solutions}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{solution}\PY{p}{[}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{solution}\PY{p}{[}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{solution\PYZus{}aux}		
        \PY{n}{new\PYZus{}solution} \PY{o}{=} \PY{n}{solution\PYZus{}aux}\PY{p}{[}\PY{p}{:}\PY{p}{]}
        \PY{k}{for} \PY{n}{solution} \PY{o+ow}{in} \PY{n}{all\PYZus{}solutions}\PY{p}{:}
            \PY{n}{new\PYZus{}value} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{n}{new\PYZus{}weight} \PY{o}{=} \PY{l+m+mi}{0}		
            \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{solution}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                \PY{k}{if} \PY{n}{solution}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{:}
                    \PY{n}{new\PYZus{}value} \PY{o}{+}\PY{o}{=} \PY{n}{aux}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
                    \PY{n}{new\PYZus{}weight} \PY{o}{+}\PY{o}{=} \PY{n}{aux}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
            \PY{k}{if} \PY{n}{new\PYZus{}weight} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{weight\PYZus{}max} \PY{o+ow}{and} \PY{n}{new\PYZus{}value} \PY{o}{\PYZgt{}} \PY{n}{value}\PY{p}{:}
                \PY{n}{new\PYZus{}solution} \PY{o}{=} \PY{n}{solution}\PY{p}{[}\PY{p}{:}\PY{p}{]}
                \PY{n}{value} \PY{o}{=} \PY{n}{new\PYZus{}value}
        \PY{k}{if} \PY{n}{new\PYZus{}solution}\PY{o}{.}\PY{n}{all}\PY{p}{(}\PY{p}{)} \PY{o}{==} \PY{n}{solution\PYZus{}aux}\PY{o}{.}\PY{n}{all}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{k}{return} \PY{n}{value}
        \PY{k}{return} \PY{n}{local\PYZus{}search}\PY{p}{(}\PY{n}{solution}\PY{p}{,} \PY{n}{aux}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{)}
    \end{Verbatim}
    \end{tcolorbox}    
...
\begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
    \PY{k}{def} \PY{n+nf}{grasp}\PY{p}{(}\PY{n}{max\PYZus{}it}\PY{p}{,} \PY{n}{window}\PY{p}{,} \PY{n}{number\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}\PY{p}{:}
        \PY{n}{best\PYZus{}solution} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{max\PYZus{}it}\PY{p}{)}\PY{p}{:}
            \PY{n}{solution}\PY{p}{,} \PY{n}{aux}\PY{p}{,} \PY{n}{value} \PY{o}{=} \PY{n}{semi\PYZus{}greedy\PYZus{}construction}\PY{p}{(}\PY{n}{window}\PY{p}{,} \PY{n}{number\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{,} \PY{n}{values\PYZus{}items}\PY{p}{,} \PY{n}{weight\PYZus{}items}\PY{p}{)}
            \PY{n}{solution} \PY{o}{=} \PY{n}{local\PYZus{}search}\PY{p}{(}\PY{n}{solution}\PY{p}{,} \PY{n}{aux}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{)}			
            \PY{k}{if} \PY{n}{solution} \PY{o}{\PYZgt{}} \PY{n}{best\PYZus{}solution}\PY{p}{:} 
                \PY{n}{best\PYZus{}solution} \PY{o}{=} \PY{n}{solution}
                \PY{n}{verify} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{k}{if} \PY{n}{solution} \PY{o}{!=} \PY{n}{best\PYZus{}solution}\PY{p}{:}
                \PY{n}{verify} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                \PY{k}{if} \PY{n}{verify} \PY{o}{==} \PY{n}{max\PYZus{}it}\PY{o}{*}\PY{l+m+mf}{0.1}\PY{p}{:} \PY{k}{return} \PY{n}{best\PYZus{}solution}
    ...
    \PY{k}{def} \PY{n+nf}{local\PYZus{}search}\PY{p}{(}\PY{n}{solution}\PY{p}{,} \PY{n}{aux}\PY{p}{,} \PY{n}{value}\PY{p}{,} \PY{n}{weight\PYZus{}max}\PY{p}{)}\PY{p}{:}
        ...
        \PY{k}{for} \PY{n}{solution} \PY{o+ow}{in} \PY{n}{all\PYZus{}solutions}\PY{p}{:}
            ...
            \PY{k}{if} \PY{n}{new\PYZus{}weight} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{weight\PYZus{}max} \PY{o+ow}{and} \PY{n}{new\PYZus{}value} \PY{o}{\PYZgt{}} \PY{n}{value}\PY{p}{:}
                \PY{n}{new\PYZus{}solution} \PY{o}{=} \PY{n}{solution}\PY{p}{[}\PY{p}{:}\PY{p}{]}
                \PY{n}{value} \PY{o}{=} \PY{n}{new\PYZus{}value}
        \PY{k}{if} \PY{n}{new\PYZus{}solution}\PY{o}{.}\PY{n}{all}\PY{p}{(}\PY{p}{)} \PY{o}{==} \PY{n}{solution\PYZus{}aux}\PY{o}{.}\PY{n}{all}\PY{p}{(}\PY{p}{)}\PY{p}{:} 
