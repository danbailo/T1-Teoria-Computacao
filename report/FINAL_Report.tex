...
Supostamente, das três heurísticas comparadas acima, a melhor seria a \textbf{Eficiente}, porém, com o intuito de provar
essa hipótese, foi realizado o cálculo do \textit{GAP}, onde, quanto menor o valor deste, melhor.
    ...
    \resizebox{0.8\textwidth}{!}{
        \begin{minipage}{\textwidth}
          ...
          \begin{tabular}{|c|c|}
            ...
            \end{tabular}  
          \caption{GAP - Heurísticas Gulosas}
        \end{minipage}}
\end{table}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{../imgs/all_grasp.pdf}
    \caption{Comparação entre resultados das Heurísticas Gulosas.}
    \label{all_grasp}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{../imgs/gap_all_grasp.pdf}
    \caption{Comparação entre resultados das Heurísticas Gulosas.}
    \label{gap_all_grasp}
\end{figure}

gap para todas as janelas/iteracao
\begin{table}[h]
    \begin{tabular}{lr}
        \toprule
        {} &         0 \\
...
a partir disso, foi desenvolvido uma logica para escolher a melhorar janela dentre o intervalo 2-9
ou seja, para cada janela, foi armazenado o indice da janela que obteve o valor maximo, de todos os valores.
No final, foi considerado a melhor janela, a que mais teve incidencia de valores maximos.
