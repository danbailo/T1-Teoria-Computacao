...
\begin{table}[htbp]
    ...
    \resizebox{0.8\textwidth}{!}{
        \begin{minipage}{\textwidth}
            ...
            \begin{tabular}{|c|c|}
                    \hline
                    \textbf{Versões - GRASP} & \textbf{Tempo/s} \\
                    \hline
                    Máx Iterações - 10000 &  801.770529 \\ \hline
                    Máx Iterações - 1000  &   79.166350 \\ \hline
                    Speed-up  &   10.1276 \\ \hline
            \end{tabular}  
...
é a versão de 1000 iterações com o tamanho de janela 7.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\linewidth]{../imgs/heuristics_compare.pdf}
    \caption{Comparação entre as melhores Heurísticas testadas.}
    \label{heuristics_compare}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\linewidth]{../imgs/time_final_cmp.pdf}
...
\begin{table}[h]
    ...
    \resizebox{0.3\textwidth}{!}{
        \begin{minipage}{\textwidth}
            ...
            \begin{tabular}{|c|c|c|}
                    \hline
                    \textbf{Versões - GRASP} & \textbf{Tempo/s} & \textbf{Speedup}\\
                    \hline
                    Exato     &  2893.456222 & - \\ \hline
                    GRASP     &    79.166350 & 36.5490\\ \hline
                    Eficiente &     0.029479 & 98153.1334\\\hline
            \end{tabular}  
          \caption{GAP entre as melhores Heurísticas testadas.}
          \label{tab:sum_time_grasp}
        \end{minipage}}
